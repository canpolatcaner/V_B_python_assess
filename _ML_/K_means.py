...
df = pd.read_csv("USArrests.csv", nrows=10) # Amerikadaki suç istatistikleri

#boş verileri sevmez clustor/K_Means o nedenle;
#df = df.dropna()   #veya;
#df = df.fillna(df.mean()) #sütun ortalamasıyla doldurmak için
