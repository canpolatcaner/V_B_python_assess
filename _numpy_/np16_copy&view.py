...
print("\naa copy yoluyla çoğaltıldığı için base (esas aldığı dizi) yok:",aa.base) # aa copy yoluyla çoğaltıldığı için base (esas aldığı dizi) yok
print("bb base (esas aldığı dizi) olarak dz nin içini gösterir",bb.base) # bb base (esas aldığı dizi) olarak dz nin içini gösterir.
